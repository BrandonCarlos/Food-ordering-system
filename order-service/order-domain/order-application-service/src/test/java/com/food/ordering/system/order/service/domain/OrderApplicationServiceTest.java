...
@TestInstance(TestInstance.Lifecycle.PER_CLASS)//Every will can have your own mock of OrderTestConfiguration.class
@SpringBootTest(classes = OrderTestConfiguration.class)//This class will use the Beans there are in OrderTestConfiguration.class
public class OrderApplicationServiceTest {
    ...
    private final UUID ORDER_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb");
    ...
    public void testCreateOrder() {
        ...
        assertEquals("Order Created Sucessfully", createOrderResponse.getMessage());
